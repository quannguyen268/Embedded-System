...
<script src="resources/model/phieu_nhap_de_tra/ajax_danh_sach_phieu_tra_hang_nhap.js"></script>
<script src="resources/model/phieu_nhap_de_tra/ajax_nhap_de_tra.js"></script>
<script src="resources/pages/quan_ly_giao_dich/tra_hang_cho_nha_cung_cap/ajax_danh_sach_phieu_tra_hang_nhap.js"></script>
<%--<script src="resources/model/khach_tra_hang/ajax_khach_tra_hang.js"></script>--%>
<!-- Main content -->
<section class="content">
    <div class="buifmaop">
        <div class="buifmaoptitle">
            <span class="page-title">Danh sách phiếu trả hàng nhập</span>
        </div>
        ...
        <div class="modal-dialog modal-lg">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Danh sách phiếu nhập</h4>
                </div>
